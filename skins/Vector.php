            ...
            switch ($element) {
                ...
                case 'PERSONAL':
                    ...
                    <div id="p-personal" role="navigation" class="<?php if (count($this->data['personal_urls']) == 0) echo ' emptyPortlet'; ?>">
                        ...
                        <?php
                        //FORUM LOGIN: change the login/register / logout links to work with the system.
                        //$phpbbUser = new phpbbSSO();
                        $phpbbUser = new phpbbSSO('./../forum/');
                        $forumURL = 'http://' . $_SERVER["SERVER_NAME"] . '/forum/';
                        ...
                        if ($phpbbUser->isAnonymous()) {
                            ...
                            if (!phpbbSSO::REQUIRE_GROUP) {
                                echo '<ul>' .
                                    '<li><a href="' . $forumURL . '/ucp.php?mode=login" title="Login" accesskey="l">Login</a></li>
                 <li><a href="' . $forumURL . '/ucp.php?mode=register">Register</a></li>' .
                                    '</ul>';
                            }
                        } else {
                            echo '<ul>' .
        '<li><a href="' . 'http://' . $_SERVER["SERVER_NAME"] . "/wiki/Special:Preferences" . '">wiki preferences</a></li> 
        <li><a href="' . $forumURL . '/ucp.php?i=pm&amp;folder=inbox"><strong>' . $phpbbUser->messages . '</strong> new messages</a></li>
        <li><a href="' . $forumURL . '/ucp.php?mode=logout&sid=' . $phpbbUser->session_id . '" title="Logout [ ' . $phpbbUser->userName . ' ]" accesskey="l">Logout [ ' . $phpbbUser->userName . ' ]</a></li>' .
                                '</ul>';
                        }
                        //FORUM LOGIN: change the login/register / logout links to work with the system.
                        ?>
