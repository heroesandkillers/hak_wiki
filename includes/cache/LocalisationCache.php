...
class LocalisationCache {
    ...
    public function isMergeableKey($key) {
        if ($this->mergeableKeys === null) {
            $this->mergeableKeys = array_flip(array_merge(
                            self::$mergeableMapKeys, self::$mergeableListKeys, self::$mergeableAliasListKeys, self::$optionalMergeKeys, self::$magicWordKeys
                    ));
        }
    ...
    public function recache($code) {
        ...
        $initialData = array_combine(
                self::$allKeys, array_fill(0, count(self::$allKeys), null));
