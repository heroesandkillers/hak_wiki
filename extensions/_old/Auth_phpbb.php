<?php
    ...
    class Auth_phpBB extends AuthPlugin implements iAuthPlugin
    {
    	...
    	public function authenticate($username, $password)
    	{
            ...
            {                
                ...
                {                 
                    ...
                    $table_user = 'wiki_user';
                    $table_group = 'wiki_user_groups';
                 ...
                 * Also check if user is a member of the phpbb group.
                 */
        ...
        public function initUser( &$user, $autocreate=false )
    	{
    		...
    		$fstrMySQLQuery = sprintf("SELECT `username_clean`, `user_email` , `user_id` 
    		                   FROM `%s`
    		                   WHERE `username_clean` = '%s'
                               LIMIT 1",
                               $this->_UserTB,
